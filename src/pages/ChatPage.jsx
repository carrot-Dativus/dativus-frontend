...
export default function ChatPage() {
  ...
  const handleSendMessage = async () => {
    ...
    setInput('');
    await sendMessage({ userQuery, currentTab, selectedAgent });
  };
  ...
  const handleClarifySubmit = (selectedOptions, otherText) => {
    ...
    setClarifyData(null);
    sendMessage({ userQuery: enrichedQuery, currentTab, selectedAgent });
  };
  ...
  const handleClarifyCancel = () => {
    ...
    setClarifyData(null);
    if (originalQuery) {
      sendMessage({ userQuery: `[skip] ${originalQuery}`, currentTab, selectedAgent });
    }
  };
